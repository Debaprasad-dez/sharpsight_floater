...
document.body.innerHTML += `<a href="" target='_blank'>
        ...
        <img src="https://debaprasad-dez.github.io/sharpsight_floater/click.svg" style="position: absolute;left:20px;top: -20px;width: 100px;z-index:-100" alt="">
        <img src="https://debaprasad-dez.github.io/sharpsight_floater/body.svg" style="position: absolute;left:0px;top: 0;width: 140px;z-index:-100" alt="">
        <img src="https://debaprasad-dez.github.io/sharpsight_floater/circle.svg" style="position: absolute;left:38px;top: 90px;width: 64px;z-index:1" alt="">
        <img src="https://debaprasad-dez.github.io/sharpsight_floater/focus.svg" id="focus" style="position: absolute;left:38px;top: 90px;width: 64px;z-index:1;transform: scale(0.4);" alt="">
        <img src="https://debaprasad-dez.github.io/sharpsight_floater/sslogo.png" style="position: absolute;left:57px;top: 13px;width: 25px;z-index:1" alt="">
        <img src="https://debaprasad-dez.github.io/sharpsight_floater/eye.png" style="position: absolute;left:57px;top: 109px;width: 25px;z-index:-10;transform: scale(1.3);" alt="">
        <div id="scan"></div>
        <style>
